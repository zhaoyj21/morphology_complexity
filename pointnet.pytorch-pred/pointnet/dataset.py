...
class ModelNetDataset(data.Dataset):
    def __init__(self,
        ...
        self.cat = {}   #类别
        with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '/data/home/zhaoyj/pointnet.pytorch/misc/owndata_id.txt'), 'r') as f:
...
if __name__ == '__main__':
    datapath = "/data/home/zhaoyj/pointnet.pytorch/owndata/"
